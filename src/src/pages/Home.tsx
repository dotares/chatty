    ...
    <div className="text-center">
      ...
      <div className="flex h-screen">
        <div className="m-auto text-center">
          ...
          <div className="my-20 bg-[#5C5470] rounded-full p-4 flex justify-center drop-shadow-xl">
            <input
              className="w-full bg-[#5C5470] text-[#FAF0E6] rounded placeholder:font-robotomono placeholder:text-[#B9B4C7] placeholder:px-2 outline-0 placeholder:text-sm"
